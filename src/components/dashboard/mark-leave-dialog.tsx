                      ...
                      renderItem={(emp: EmployeeDropdownItem) => (
                        <div className="flex flex-col gap-0.5">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-black text-emerald-600 uppercase tracking-tighter">ID: {emp.employeeId}</span>
                          </div>
                          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tight">Punch ID: {emp.uniqueId || "N/A"}</span>
                        </div>
                      )}
